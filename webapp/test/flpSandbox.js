		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ODATA CRUDQ",
									"targetURL": "#odataui5odatacrudqprac-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataui5odatacrudqprac-display": {
								"semanticObject": "odataui5odatacrudqprac",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.ui5.odatacrudqprac",
									"url": sap.ui.require.toUrl("odata/ui5/odatacrudqprac")
								}
							}
						}
					}
